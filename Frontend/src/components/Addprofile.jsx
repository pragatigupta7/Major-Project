                ...
                <form onSubmit={Addprofile.handleSubmit} >
                  ...
                  {/*}  <div data-mdb-input-init="" className="form-outline mb-4">
                    <input
                      type="text"
                      id="category"
                      className="form-control" onChange={Addprofile.handleChange} value={Addprofile.values.category} />
                    <label className="form-label" htmlFor="form3Example3">
                      Category
                    </label>
      </div>*/}
                  <div className="dropdown">
                    <button className="btn btn-secondary dropdown-toggle" type="button" id="category" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" onChange={Addprofile.handleChange} value={Addprofile.values.category}>
                     Category
                    </button>
                    <div className="dropdown-menu" aria-labelledby="dropdownMenuButton">
                      <Link className="dropdown-item" to="#">IT</Link>
                      <Link className="dropdown-item" to="#">DigitalMarketing</Link>
                      <Link className="dropdown-item" to="#">Management</Link>
                    </div>
                  </div>
                  ...
                  <div data-mdb-input-init="" className="form-outline mb-4">
                    <input
                      type="text"
                      id="Features"
                      className="form-control" onChange={Addprofile.handleChange} value={Addprofile.values.Features} />
                    <label className="form-label" htmlFor="form3Example4">
                      Feature 1
                    </label>
                  </div>
