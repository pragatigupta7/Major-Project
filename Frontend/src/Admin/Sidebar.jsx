    ...
    <div className="content mt-3">
      <div className="col-sm-12">
        <div
          ...
          role="alert"
        >
          <span className="badge badge-pill badge-success">Success</span> You
      ...
      <div className="col-lg-3 col-md-6">
        <div className="social-box facebook">
          ...
          <ul>
            <li>
              <span className="count">40</span> k<span>friends</span>
            </li>
            <li>
      ...
      <div className="col-lg-3 col-md-6">
        <div className="social-box twitter">
          ...
          <ul>
            <li>
              <span className="count">30</span> k<span>friends</span>
            </li>
            <li>
              <span className="count">450</span>
              <span>tweets</span>
      ...
      <div className="col-lg-3 col-md-6">
        <div className="social-box linkedin">
          ...
          <ul>
            <li>
              <span className="count">40</span> +<span>contacts</span>
            </li>
            <li>
      ...
      <div className="col-lg-3 col-md-6">
        <div className="social-box google-plus">
          ...
          <ul>
            <li>
              <span className="count">94</span> k<span>followers</span>
            </li>
            <li>
